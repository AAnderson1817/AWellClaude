...
jump is 4.0). Press jump as you meet it and it is 6.0: a press counts from 6 frames
...
A bounce is the bulb's, so the jump cut does not apply to it (`player.launched`).
    ...
    measured   no press 5.24   pressed 1-6 frames early 6.04   1-4 late 6.04-5.93
