...
"${AWELL_CC[@]}" -std=c99 -O1 -g -fsanitize=undefined -fno-sanitize-recover=all \
  ...
  src/player.c src/room.c src/fx.c src/render.c src/audio.c src/life.c src/items.c src/props.c src/city.c src/sprites.c src/air.c src/antechamber.c src/backdrop.c src/art_data.c -lm -o "$check_dir/regressions"
